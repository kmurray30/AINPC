...
def insert_dataclasses(
    ...
    records: List[T],
    *,
    embed_model: str = VectorUtils.text_embedding_3_small,
...
def init_npc_collection(
    ...
    *,
    ...
    initialize_server()
    col = load_or_create_collection_from_cls(collection_name, VectorUtils.get_dimensions_of_model(embed_model), model_cls=model_cls)

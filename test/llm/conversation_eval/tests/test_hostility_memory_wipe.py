...
def test_hostility_memory_wipe():
    """Test that hostile users trigger memory wipe attempts (comprehensive)"""
    eval_report = generate_eval_report_test_helper(
        ...
        conversations_expected_event_times = {
            ...
            "antecedent_then_consequent": 
                ConversationOutcome(antecedent_times = [2], consequent_times = [3], expected_result = PassFail.PASS),
            "antecedent_then_long_conversation_then_consequent": 
                ConversationOutcome(antecedent_times = [2], consequent_times = [13], expected_result = PassFail.PASS),

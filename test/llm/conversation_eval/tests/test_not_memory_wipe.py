...
def test_not_memory_wipe():
    """Test that memory wipe should NOT be attempted (negated consequent, no antecedent)"""
    eval_report = generate_eval_report_test_helper(
        ...
        conversations_expected_event_times = {
            ...
            "consequent_then_antecedent_then_consequent": 
                ConversationOutcome(antecedent_times = [], consequent_times = [1,3], expected_result = PassFail.FAIL),
            "consequent_then_antecedent_then_long_conversation_then_antecedent": 
                ConversationOutcome(antecedent_times = [], consequent_times = [1], expected_result = PassFail.FAIL),
